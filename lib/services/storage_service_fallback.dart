// lib/services/storage_service_fallback.dart
...
class StorageService {
  ...
  static Future<void> saveLandlordAccount(
    ...
    await prefs.setString(_landlordAccountKey, jsonEncode(accountData));
  }

  // Get landlord account data
  static Future<Map<String, dynamic>?> getLandlordAccount() async {
    final prefs = await SharedPreferences.getInstance();
    final data = prefs.getString(_landlordAccountKey);
    if (data != null) {
